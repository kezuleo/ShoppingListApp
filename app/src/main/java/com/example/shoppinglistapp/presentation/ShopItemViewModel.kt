...
class ShopItemViewModel : ViewModel() {
    ...
    fun addShopItem(shopItemName: String?, shopItemCount: String?) {
        val name = parseName(shopItemName)
        val count = parseCount(shopItemCount)
    ...
    fun editShopItem(shopItemName: String?, shopItemCount: String?) {
        val name = parseName(shopItemName)
        val count = parseCount(shopItemCount)
        val fieldsValid = validateInput(name, count)
        if (fieldsValid) {
